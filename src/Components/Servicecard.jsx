...
function Servicecard({service}) {
  ...
  return (
    ...
    border-gray-200 dark:border-gray-700 shadow-2xl shadow-gray-100 dark:shadow-white/10' onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>setVisible(false)}
    ref={divRef} onMouseMove={handleMouseMove}>
        ...
        transition-opacity duration-500 mix-blend-lighten opacity-70  ${visible ? 'opacity-70 ' : 'opacity-0'}`} style={{top:
            ...
            transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                ...
                <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
                    <img className='max-w-24 bg-white dark:bg-gray-900 rounded-full m-2' src={service.icon}/>
                </div>
